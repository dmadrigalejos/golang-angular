...
1. Include metismenu StyleSheet
  ...
  ```html
  <link rel="stylesheet" href="//cdn.jsdelivr.net/jquery.metismenu/2.6.2/metisMenu.min.css">
  ```
...
3. Include metisMenu plugin's code
  ...
  ```
      OR
  ```html
  <script src="//cdn.jsdelivr.net/jquery.metismenu/2.6.2/metisMenu.min.js"></script>
  ```
...
| **Commits** | **Contributor** |  
| --- | --- |  
| 109 | [onokumus](https://github.com/onokumus) |  
